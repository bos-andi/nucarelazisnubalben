                    ...
                    <tr class="border-t border-slate-100 hover:bg-slate-50">
                        <td class="px-6 py-4">
                            @if($article->thumbnail)
                                <img src="{{ $article->thumbnail }}" alt="{{ $article->title }}" class="w-16 h-12 object-cover rounded-lg border border-slate-200">
                            @elseif($article->cover_image)
                                <img src="{{ $article->cover_image }}" alt="{{ $article->title }}" class="w-16 h-12 object-cover rounded-lg border border-slate-200">
                            @else
