...
@section('title', 'Edit Khutbah Jum\'at')
...
<div class="p-6">
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-xs uppercase tracking-[0.4em] text-nu-600 font-semibold">Edit Khutbah</p>
                <h1 class="text-3xl font-bold text-slate-900 mt-2">Edit Khutbah Jum'at</h1>
            </div>
        ...
        <form action="{{ route('admin.khutbah.update', $khutbah) }}" method="POST" class="mt-8 bg-white rounded-3xl shadow-lg border border-slate-100 p-8 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title', $khutbah->title) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="slug" value="{{ old('slug', $khutbah->slug) }}"
                           class="mt-2 w-full rounded-2xl border-slate-200 focus:ring-nu-500 focus:border-nu-500"
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="date" name="khutbah_date" value="{{ old('khutbah_date', $khutbah->khutbah_date->format('Y-m-d')) }}" required
                           class="mt-2 w-full rounded-2xl border-slate-200 focus:ring-nu-500 focus:border-nu-500">
                </div>

                <div>
                    <label class="text-sm font-semibold text-slate-600">Nama Khatib</label>
                    <input type="text" name="khatib" value="{{ old('khatib', $khutbah->khatib) }}"
                           class="mt-2 w-full rounded-2xl border-slate-200 focus:ring-nu-500 focus:border-nu-500"
                ...
                <div>
                    ...
                    <input type="text" name="location" value="{{ old('location', $khutbah->location) }}"
                           class="mt-2 w-full rounded-2xl border-slate-200 focus:ring-nu-500 focus:border-nu-500"
            ...
            <div>
                ...
                <input type="hidden" name="content" id="body-input" value="{{ old('content', $khutbah->content) }}" required>
            ...
            <div>
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_published" id="is_published" value="1" {{ old('is_published', $khutbah->is_published) ? 'checked' : '' }}
