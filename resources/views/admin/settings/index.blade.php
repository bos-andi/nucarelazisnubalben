...
@section('title', 'Pengaturan Website - Lazisnu Balongbendo')
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        @if($settings->get('site_logo')?->value)
                            <div class="mt-3">
                                <img src="{{ $settings->get('site_logo')->value }}" alt="Current logo" class="h-16 object-contain">
                    ...
                    <div>
                        ...
                        @if($settings->get('site_favicon')?->value)
                            <div class="mt-3">
                                <img src="{{ $settings->get('site_favicon')->value }}" alt="Current favicon" class="h-8 w-8 object-contain">
                    ...
                    <div>
                        ...
                        <input type="text" name="site_title" value="{{ old('site_title', $settings->get('site_title')?->value ?? 'Balongbendo Newsroom') }}" required class="mt-2 w-full rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="site_subtitle" value="{{ old('site_subtitle', $settings->get('site_subtitle')?->value ?? 'Lazisnu MWC NU') }}" required class="mt-2 w-full rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="bg-white rounded-xl p-6 card-shadow">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="hero_title" value="{{ old('hero_title', $settings->get('hero_title')?->value ?? 'Kabar Kebaikan & Aksi Hijau Dari Bumi Balongbendo') }}" required class="mt-2 w-full rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <textarea name="hero_description" rows="3" required class="mt-2 w-full rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{ old('hero_description', $settings->get('hero_description')?->value ?? 'Menguatkan gerakan zakat, infak, sedekah, dan program sosial untuk menghadirkan kemandirian ekonomi umat.') }}</textarea>
