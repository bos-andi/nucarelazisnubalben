...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard - Lazisnu Balongbendo'); ?></title>
            ...
            <div class="flex flex-col flex-grow pt-5 overflow-y-auto sidebar-gradient">
                        ...
                        <div class="relative flex items-center gap-3 flex-1" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center focus:outline-none">
                                <?php if(auth()->user()->avatar): ?>
                                    <img src="<?php echo e(auth()->user()->avatar); ?>" alt="<?php echo e(auth()->user()->name); ?>" class="h-10 w-10 rounded-xl object-cover border-2 border-white/20 hover:border-white/40 transition-colors shadow-lg">
                                <?php else: ?>
                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-2">
                                    <p class="text-white font-semibold text-lg"><?php echo e(auth()->user()->name); ?></p>
                                    <?php if(auth()->user()->isSuperAdmin()): ?>
                                        <!-- Superadmin Badge -->
                                        <svg class="h-5 w-5 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                        </svg>
                                    <?php elseif(auth()->user()->isContributor() && auth()->user()->hasVerifiedKtp()): ?>
                                ...
                                <p class="text-slate-300 text-xs">
                                    <?php if(auth()->user()->role === 'superadmin'): ?>
                                        Superadmin
                                    <?php elseif(auth()->user()->role === 'contributor'): ?>
                                        Kontributor
                                    <?php else: ?>
                            ...
                            <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute left-0 top-full mt-2 w-56 rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 z-[60]" style="display: none;">
                                <div class="py-1">
                                    ...
                                    <a href="<?php echo e(route('admin.profile.show')); ?>" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                        <svg class="mr-3 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                        </svg>
                                        Profil Saya
                                    </a>
                                    <a href="<?php echo e(route('admin.profile.show')); ?>#password" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                        <svg class="mr-3 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-8 flex-1 flex flex-col">
                    <nav class="flex-1 px-4 space-y-1">
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                        ...
                        <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasAnyPermission(['manage_articles', 'manage_gallery', 'manage_khutbah'])): ?>
                        <div class="pt-4">
                            <p class="px-3 text-xs font-semibold text-slate-400 uppercase tracking-wider">Konten</p>
                            <div class="mt-2 space-y-1">
                                <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('manage_articles')): ?>
                                <a href="<?php echo e(route('admin.articles.index')); ?>" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('admin.articles.*') ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <?php endif; ?>
                                <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('manage_gallery')): ?>
                                <a href="<?php echo e(route('admin.gallery.index')); ?>" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('admin.gallery.*') ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <?php endif; ?>
                                <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('manage_khutbah')): ?>
                                <a href="<?php echo e(route('admin.khutbah.index')); ?>" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('admin.khutbah.*') ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasAnyPermission(['manage_categories', 'manage_tags', 'manage_programs'])): ?>
                        <div class="pt-4">
                            <p class="px-3 text-xs font-semibold text-slate-400 uppercase tracking-wider">Master Data</p>
                            <div class="mt-2 space-y-1">
                                <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('manage_categories')): ?>
                                <a href="<?php echo e(route('admin.categories.index')); ?>" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('admin.categories.*') ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <?php endif; ?>
                                <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('manage_tags')): ?>
                                <a href="<?php echo e(route('admin.tags.index')); ?>" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('admin.tags.*') ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                                    </svg>
                                    Tag
                                ...
                                <?php endif; ?>
                                <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('manage_programs')): ?>
                                <a href="<?php echo e(route('admin.programs.index')); ?>" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('admin.programs.*') ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="pt-4">
                            ...
                            <div class="mt-2 space-y-1">
                                <a href="<?php echo e(route('admin.contributors.index')); ?>" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('admin.contributors.*') ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasAnyPermission(['manage_settings', 'manage_adsense', 'manage_organization', 'manage_contact', 'manage_system_updates'])): ?>
                        <div class="pt-4">
                            <p class="px-3 text-xs font-semibold text-slate-400 uppercase tracking-wider">Pengaturan</p>
                            <div class="mt-2 space-y-1">
                                <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('manage_settings')): ?>
                                <a href="<?php echo e(route('admin.settings.index')); ?>" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('admin.settings.*') ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <?php endif; ?>
                                <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('manage_adsense')): ?>
                                <a href="<?php echo e(route('admin.adsense.index')); ?>" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('admin.adsense.*') ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <?php endif; ?>
                                <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('manage_organization')): ?>
                                <a href="<?php echo e(route('admin.organization.index')); ?>" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('admin.organization.*') ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <?php endif; ?>
                                <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('manage_contact')): ?>
                                <a href="<?php echo e(route('admin.contact.index')); ?>" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('admin.contact.*') ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <?php endif; ?>
                                <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasPermission('manage_system_updates')): ?>
                                <a href="<?php echo e(route('admin.system-updates.index')); ?>" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('admin.system-updates.*') ? 'bg-white/10 text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white shadow-sm border-b border-gray-200">
                <div class="px-4 py-3 flex items-center justify-between">
                    ...
                    <div class="hidden md:flex items-center gap-3 ml-auto">
                        <a href="<?php echo e(route('home')); ?>" target="_blank" class="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 hover:text-nu-600 hover:bg-gray-50 rounded-lg transition-colors">
...
<?php /**PATH C:\xampp8.1\htdocs\lazisnubalongbendo\resources\views/layouts/admin.blade.php ENDPATH**/ ?>